...
class ProductController extends Controller
{
    ...
    public function store(ProductStoreRequest $request)
    {
        ...
        if($request->has('image')){
            ...
            $data['feature_image_url'] = $image_path;
        }

        Product::create($data);

        return redirect()->route('products.index')->with(['status' => 'Success','color' =>'green', 'message' => 'Producto ingresado satisfactoriamente']);
    ...
    public function update(ProductStoreRequest $request, Product $product)
    {
        ...
        if($request->has('image')){
            Storage::delete($product->feature_image_url);
    ...
    public function destroy(Product $product)
    {
        try {
            ...
            $result = ['status' => 'Error','color' =>'red', 'message' => 'Ocurrio un error al eliminar el registro'];
        }
